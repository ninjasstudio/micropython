...
{ MP_ROM_QSTR(MP_QSTR_STAT_CONNECTION_FAIL), MP_ROM_INT(WIFI_REASON_CONNECTION_FAIL)},
{ MP_ROM_QSTR(MP_QSTR_STAT_AP_TSF_RESET), MP_ROM_INT(WIFI_REASON_AP_TSF_RESET)},
{ MP_ROM_QSTR(MP_QSTR_STAT_ROAMING), MP_ROM_INT(WIFI_REASON_ROAMING)},
{ MP_ROM_QSTR(MP_QSTR_STAT_ASSOC_COMEBACK_TIME_TOO_LONG), MP_ROM_INT(WIFI_REASON_ASSOC_COMEBACK_TIME_TOO_LONG)},
{ MP_ROM_QSTR(MP_QSTR_STAT_SA_QUERY_TIMEOUT), MP_ROM_INT(WIFI_REASON_SA_QUERY_TIMEOUT)},
