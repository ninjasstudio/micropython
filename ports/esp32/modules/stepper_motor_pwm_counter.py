...
class StepperMotorPwmCounter:
    def __init__(self, pin_step, pin_dir, freq=5_000, reverse=0):
    ...
    def freq(self, freq):
        ...
        self._us_step_period = round(1_000_000 / self._freq)  # pulse period in µs
        #print(f'Stepper.setter.freq(): self._freq={self._freq}, self._us_step_period={self._us_step_period}')
    ...
    def irq_handler(self, obj):
        ...
        print(f" irq_handler: steps_over_run={self._steps_over_run}, counter.get_value()={self._counter.get_value()}") # , obj={obj}
