...
class PID(object):
    ...
    def components(self):
        ...
        """
        return self._proportional, self._integral, self._derivative  #, 'setpoint', self.setpoint, '_last_input', self._last_input, '_last_error', self._last_error, '_error', self._error, '_d_input', self._d_input
